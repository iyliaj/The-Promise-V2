        ...
        <div className="mainpage-container relative w-full h-screen overflow-hidden">
            ...
            <div className={`padding-container w-full h-full flex justify-center items-center relative ${isDesktopOrLaptop ? "p-20" : ""}`}>
                ...
                <div className={`content-container bg-canvas dark:bg-secondary relative pt-1 w-full ${isDesktopOrLaptop ? "h-full rounded-2xl flex flex-col items-center" : "h-full flex flex-col justify-center"}`}>
                    ...
                    {isDesktopOrLaptop && (
                        <div className="w-full px-5 h-[15%] flex items-center">
                    ...
                    {(isDesktopOrLaptop && newPromiseStatus) && (
                        <div className={`w-[50%] h-[65%] max-h-[500px] ${isDesktopOrLaptop ? "absolute z-50 bottom-0 right-0" : "relative"}`} ref={formRef}>
                            <NewPromiseForm
                                handleClick={handleClick}
                                setUserData={setUserData}
                                playPopSound={playPopSound}
