...
export function NewPromiseForm({ handleClick, setUserData }) {
    ...
    return (
        <div className="new-promise-section w-full h-100 bg-secondary rounded-md relative overflow-hidden">
            ...
            <div className="w-full h-full absolute z-5 top-0 left-0 p-8">
                ...
                <div className="new-promise-btns flex flex-col gap-2 absolute bottom-13 right-3">
                    <button
