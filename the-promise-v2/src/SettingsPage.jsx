...
export function SettingsPage({ userData, setUserData, setFontType, isSoundOn, setIsSoundOn, isDefaultFontSize, setIsDefaultFontSize, isDesktopOrLaptop, handleSettingsViewClick }) {
    ...
    const handleClick = (e) => {
        ...
        // Read current theme directly from DOM
        ...
        // Apply theme directly to <html> — no React state, no re-render
        if (newTheme === "dark") {
        ...
        <div className="settings-page h-screen">
            ...
            <div className={`bg-canvas dark:bg-primary settings-page-container ${isDesktopOrLaptop ? "rounded-md w-full h-155" : "mt-5 h-[85%]"} p-5`}>
                <div className={`settings-container w-full ${!isDesktopOrLaptop ? "h-[92%] mt-8" : "h-130 mt-6"} bg-secondary rounded-md overflow-hidden relative`}>
                    ...
                    <svg height="830" viewBox="0 0 290 30" fill="none" xmlns="http://www.w3.org/2000/svg">
